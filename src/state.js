...
export const S = {
  ...
  lockTimer: 0,          // 탭 잠금 심장박동 (v101)
  otherTab: null,        // 다른 탭이 이 슬롯을 쥐고 있나
  saveFailed: false,     // 저장이 실패한 채인가 — 계기판에 남긴다 (v100)
  ...
  tradedThisSession: false,     // 다음 「새 세계」의 지형 — 지금 세계의 S.terrain 과 따로 든다 (v121)
