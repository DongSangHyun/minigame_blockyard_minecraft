...
| `toast(msg)` | 247 |
| `mmZoomNow()` | 264 |
| `refreshMinimapCap()` | 265 |
| `roofDepth(x, z, y)` | 288 |
| `naturalRoof(x, z, y)` | 304 |
| `refreshMouthDots()` | 340 |
| `bigMapOpen()` | 379 |
| `drawBigMap()` | 381 |
| `toggleBigMap(on)` | 382 |
| `drawMinimap()` | 396 |
| `drawMinimapTo(ctx, scale, full)` | 400 |
| `helpOpen()` | 650 |
| `toggleHelp(on)` | 651 |
| `setHelpTab(showAch)` | 672 |
| `bootProgress(msg, frac)` | 687 |
| `bootDone()` | 692 |
| `noteBlockUse(b)` | 703 |
| `sortPickByRecent()` | 712 |
| `refreshPickFilter()` | 723 |
| `openCmd()` | 750 |
| `closeCmd()` | 757 |
| `cmdSay(msg)` | 762 |
| `drawPreview(target)` | 768 |
...
| `agoText(ms)` | 107 |
| `refreshSlots()` | 123 |
| `aimCell(reach, strict)` | 213 |
| `selectionText()` | 227 |
| `afterWorldSwap(msg, loaded)` | 243 |
| `cloudSay(msg, kind)` | 306 |
| `refreshCloud()` | 311 |
| `refreshTerrain()` | 421 |
| `refreshBindLabels()` | 449 |
| `hintText(base)` | 457 |
| `refreshKeyButtons()` | 464 |
| `bindConflict(act, code)` | 500 |
| `shareLink()` | 537 |
| `refreshBlueprints()` | 550 |
| `refreshResume()` | 596 |
| `refreshMenu()` | 642 |
| `beginPlay()` | 657 |
| `endPlay()` | 694 |
